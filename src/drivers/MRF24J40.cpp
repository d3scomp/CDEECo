...
bool MRF24J40::recvPacket(uint8_t (&data)[CDEECO::KnowledgeFragment::MAX_PACKET_SIZE], uint8_t& dataLength, uint8_t (&srcPanId)[2], uint8_t (&srcSAddr)[2], uint8_t (&fcs)[2], uint8_t& lqi, uint8_t& rssi) {
